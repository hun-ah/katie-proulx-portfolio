export const content = {
  ...
  numberedList1: [
    ...
    {
      number: 2,
      text: 'Send out a message to the injured athlete’s emergency contacts',
    },
    {
      number: 3,
      text: 'Send an automated message to 112 (EMS in France)',
    },
    {
      number: 4,
      text: 'If the injured athlete recovers, how can they cancel the call for help, and how will that notify all parties?',
    },
  ],
  numberedList2: [
    {
